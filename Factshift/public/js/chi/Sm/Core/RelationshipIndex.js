    ...
    Sm.Core.RelationshipIndex = Class.extend(
        {
            ...
            init:                            function (settings) {
                ...
                this.r_id_map = {};
                this._to_delete = {};
                Sm.loaded.when_loaded('Core_RelationshipIndexView', function () {
                    Sm.Core.Abstraction.View.mixin(self);
                });
            },
            createView:                      function (parameters) {
                return new Sm.Core.RelationshipIndex.View(parameters);
            },
            /**
            ...
            locate:                          function (identifier, context_id) {
                ...
                if (identifier.Identity) return this.locate(identifier.Identity, context_id);
             ...
             * @param {number|r_id=}   context_id      The context of the relationship's existence. Main if not specified
