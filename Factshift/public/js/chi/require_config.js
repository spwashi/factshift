...
if (typeof SPWASHI_JS_URL === "undefined")
	var SPWASHI_JS_URL = "/resource/js/";
var CHI_URL = SPWASHI_JS_URL + "chi/";
require.config(
{
	paths: {
		jquery:      SPWASHI_JS_URL + "vendor/jquery.min",
		Promise:     SPWASHI_JS_URL + "std/Promise",
		backbone:    SPWASHI_JS_URL + "vendor/backbone",
		Cocktail:    SPWASHI_JS_URL + "vendor/Cocktail",
		underscore:  SPWASHI_JS_URL + "vendor/underscore",
		crossvent:   SPWASHI_JS_URL + "vendor/crossvent",
		inflection:  SPWASHI_JS_URL + "vendor/underscore.inflection",
		tooltipster: SPWASHI_JS_URL + "vendor/jquery.tooltipster.min",
		select2:     SPWASHI_JS_URL + "vendor/select2",

		SmHighlight: SPWASHI_JS_URL + "std/sm_highlight",
		...
		"Sm-Core-Abstraction-View":         CHI_URL + "Sm/Core/Abstraction/View",
		...
		"Sm-Core-RelationshipIndexView":    CHI_URL + "Sm/Core/RelationshipIndexView",
