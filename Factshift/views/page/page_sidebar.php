 ...
 * Time: 7:15 PM
 */
use Factshift\Entity\Concept;
use Factshift\Entity\Dictionary;
use Sm\Security\XSS;
...
<section class="module">
    <header>
        ...
        <?php if ($is_edit) : ?><i class="fa fa-plus-circle add-dictionary"></i><?php endif; ?>
    </header>
    <div class="content">
        <ul class="lst dictionary-container entity-container no-selection">
            <?php foreach ($dictionaries as $dictionary): ?>
                ...
                ?>
                <li class="lst-tag factshift-entity factshift-dictionary"
                    data-id="<?= $d_id ?>"
                    data-user_id="<?= $d_u_id ?>"
...
<section class="module">
    <header>
        ...
        <?php if ($is_edit) : ?><i class="fa fa-plus-circle add-concept"></i><?php endif; ?>
    </header>
    <div class="content">
        <ul class="lst concept-container entity-container no-selection">
            <?php foreach ($concepts as $concept): ?>
                ...
                ?>
                <li class="lst-tag factshift-entity factshift-concept"
                    data-id="<?= $c_id ?>"
                    data-user_id="<?= $c_u_id ?>"
