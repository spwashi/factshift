...
use Sm\Security\XSS;
use Factshift\Model\Collection;
...
<section class="module">
    ...
    <div class="content">
        <ul id="collection-container" class="lst collection-container factshift-entity entity-container no-selection">
            <?php foreach ($collections as $index => $collection): ?>
                ...
                ?>
                <li class="lst-tag factshift-entity factshift-collection "
                    data-id="<?= $c_id ?>"
