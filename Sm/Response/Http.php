...
/**
 * Class Http
 * Predominantly static class to set HTTP status headers and redirect URLs
 *
 * @package Sm\Response
 */
class Http {
     ...
     * Redirect to a URL
     *
     * @param string $url     The URL to which we should redirect
     * @param bool   $replace Whether or not to replace the URL or to in the browser, or keep the visitation history
     * @param int    $code    The HTTP response code to return to the browser
     */
    public static function redirect($url, $replace = false, $code = 302) {
        static::set_status_header($code);
     ...
     * @return string
     */
    public static function get_message_from_code($code) {
        switch ($code) {
            case 100:
                $text = 'Continue';
                break;
     ...
     * @return string
     */
    public static function get_mime_from_extension($type) {
        $mime_types_map = [
