...
class UserHandler extends UpdatedForm {
    ...
    public static function validate_name(&$form_value, $data = null, $change_to_default = false, $is_last_name = false) {
        ...
        return static::process_validation_result($validity, $messages, $is_last_name ? 'last_name' : 'name');
    }
    ...
    public function validate_password(&$form_value = 'password') {
    ...
    public function validate_email(&$form_value = 'email') {
