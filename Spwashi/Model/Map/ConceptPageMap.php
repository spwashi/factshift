 ...
 * @property string $alias                The name of the concept w/r to the page (useful for url query string tab
 *           selecting)
 * @property string $description          Description of why the concept is on the page
 * @property int    $position             Position of the concept in relation to others, the index
 */
class ConceptPageMap extends Map implements \JsonSerializable {
    ...
    public static $_map_type       = 'Concept|Page';
