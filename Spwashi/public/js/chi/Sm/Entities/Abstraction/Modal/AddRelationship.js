...
require(['require', 'Class', 'Sm', 'Sm/Extras/Modal'], function (require, Class) {
    Sm.loaded.when_loaded(['Extras_Modal'], function () {
         ...
         * @prop {Array} Sm.Entities.Abstraction.Modal.AddRelationship.MvComboArr {@see Sm.Entities.Abstraction.Modal.AddRelationship.MvComboArr}
         */
